...
const DAILY_QUEST_TEMPLATES = [
  {
    ...
    title: 'Saqueador del día',
    summary: 'Ataca 3 campos bárbaros hoy',
    target: 3,
  ...
  },
  {
    ...
    summary: 'Entrena 20 unidades hoy',
    target: 20,
    type: 'TRAIN_UNITS',
  ...
  },
  {
    ...
    title: 'Comerciante',
    summary: 'Envía 1 caravana de comercio',
    target: 1,
    type: 'SEND_TRADE',
  ...
  },
  {
    ...
    title: 'Guerrero',
    summary: 'Lanza 1 ataque a otro jugador',
    target: 1,
    type: 'ATTACK_PLAYER',
  ...
  },
  {
    ...
    title: 'Aliado leal',
    summary: 'Contribuye al objetivo de alianza',
    target: 1,
