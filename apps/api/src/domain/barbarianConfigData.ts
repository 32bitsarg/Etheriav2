...
export const LOCAL_BARBARIAN_ZONE_CONFIGS: BarbarianZoneConfig[] = [
  {
    ...
    minDistanceToCities: 15,
    minDistanceBetweenCamps: 10,
  ...
  },
  {
    ...
    minDistanceToCities: 10,
    minDistanceBetweenCamps: 8,
  ...
  },
  {
    ...
    minDistanceToCities: 8,
    minDistanceBetweenCamps: 12,
