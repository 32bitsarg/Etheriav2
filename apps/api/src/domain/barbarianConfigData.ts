...
// Distances are in world-space pixels. Map is 12000×12000px.
// minDistanceToCities: keep camps away from player cities
// minDistanceBetweenCamps: spread camps so they don't cluster
// maxDensity: max simultaneous camps per zone (7 zones × avg 20 = ~140 camps for 1000 players)
export const LOCAL_BARBARIAN_ZONE_CONFIGS: BarbarianZoneConfig[] = [
  {
    ...
    minDistanceToCities: 280,
    minDistanceBetweenCamps: 500,
  ...
  },
  {
    ...
    minDistanceToCities: 250,
    minDistanceBetweenCamps: 450,
  ...
  },
  {
    ...
    minDistanceToCities: 260,
    minDistanceBetweenCamps: 480,
    spawnIntervalSeconds: 300,
  },
  {
    zoneId: 'forest',
