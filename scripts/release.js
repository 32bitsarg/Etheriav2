...
const VERSION_NAMES = [
  ...
  { version: "0.0.2", name: "Las Primeras Alianzas" },
  { version: "0.0.3", name: "La Forja de Armas" },
  { version: "0.0.4", name: "Los Mercaderes Errantes" },
  { version: "0.0.5", name: "El Muro del Norte" },
  { version: "0.1.0", name: "El Gran Asedio" },
  { version: "0.1.1", name: "La Caída de los Templos" },
  { version: "0.1.2", name: "La Rebelión de los Clanes" },
  { version: "0.2.0", name: "El Comercio de Especies" },
  { version: "0.2.1", name: "La Gran Ruta Comercial" },
  { version: "0.3.0", name: "Las Ruinas Olvidadas" },
  { version: "0.3.1", name: "El Despertar de los Antiguos" },
  { version: "0.4.0", name: "El Pacto de Sangre" },
  { version: "0.4.1", name: "La Guerra Fratricida" },
  { version: "0.5.0", name: "La Edad de los Héroes" },
  { version: "0.5.1", name: "El Ascenso del Campeón" },
  { version: "0.6.0", name: "La Tormenta Inminente" },
  { version: "0.7.0", name: "El Eclipse Eterno" },
  { version: "0.8.0", name: "La Invasión de las Sombras" },
  { version: "0.9.0", name: "El Último Bastión" },
  { version: "0.9.9", name: "La Calma Antes de la Tormenta" },
